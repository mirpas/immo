		...
		<div class="card {{ $cardClass ?? 'card-primary' }}">
			...
			<div class="card-body">
				<div class="form-group">
					...
					<select
						class="custom-select @error('building_id') is-invalid @enderror"
						id="building_id"
						name="building_id">
                      @foreach($buildings as $building)
                      	<option
                      		value="{{ $building->id }}" {{ old('building_id', $flat->building->id ?? '') == $building->id ? 'selected' : ''}}>
                      		{{ $building->short_name }}
                      	</option>
                      @endforeach
                    </select>
				...
				<div class="form-group">
					...
					<input
						...
						name="short_name"
						value="{{ old('short_name', $flat->short_name ?? '') }}">
				</div>{{-- form-group --}}
				<div class="form-group">
					...
					<input
						...
						name="description"
						value="{{ old('description', $flat->description ?? '') }}">
				</div>{{-- form-group --}}
				<div class="form-group">
					<label for="flat_type_id">Typ</label>
					<select
						class="custom-select @error('flat_type_id') is-invalid @enderror"
						id="flat_type_id"
						name="flat_type_id">
                      @foreach($flatTypes as $flatType)
                      	<option
                      		value="{{ $flatType->id }}" {{ old('flat_type_id', $flat->flatType->id ?? '') == $flatType->id ? 'selected' : ''}}>
				...
				<div class="form-group">
					...
					<input
						...
						name="no_of_rooms"
						value="{{ old('no_of_rooms', $flat->no_of_rooms ?? '') }}">
				</div>{{-- form-group --}}
				<div class="form-group">
					...
					<input
						...
						value="{{ old('year_of_last_renovation', $flat->year_of_last_renovation ?? '') }}">
				</div>{{-- form-group --}}
				<div class="form-group">
		...
		<div class="card collapsed-card">
			...
			<div class="card-body">
				<div class="form-group">
					...
					<input
						type="text"
						class="form-control @error('weg_mieteigentumsanteil') is-invalid @enderror"
						id="weg_mieteigentumsanteil"
						placeholder="Mieteigentumsanteil"
						name="weg_mieteigentumsanteil"
						value="{{ old('weg_mieteigentumsanteil', $flat->weg_mieteigentumsanteil ?? '') }}">
				</div>{{-- form-group --}}
				<div class="form-group">
					<label for="weg_kopfstimmen">Kopfstimmen</label>
					<input
						type="text"
						class="form-control @error('weg_kopfstimmen') is-invalid @enderror"
						id="weg_kopfstimmen"
						placeholder="Kopfstimmen"
						name="weg_kopfstimmen"
						value="{{ old('weg_kopfstimmen', $flat->weg_kopfstimmen ?? '') }}">
				</div>{{-- form-group --}}
				<div class="form-group">
					<label for="weg_hausgeld">Hausgeld</label>
					<input
						type="text"
						class="form-control @error('weg_hausgeld') is-invalid @enderror"
						id="weg_hausgeld"
						placeholder="Hausgeld"
						name="weg_hausgeld"
						value="{{ old('weg_hausgeld', $flat->weg_hausgeld ?? '') }}">
				</div>{{-- form-group --}}
			</div><!-- /.card-body -->
		</div><!-- /.card -->
	</div>{{-- /.col-md-6 --}}
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="form-group">
					...
					<input
						type="text"
						class="form-control @error('din_area') is-invalid @enderror"
						id="din_area"
						placeholder="DIN-Fläche"
						name="din_area"
						value="{{ old('din_area', $flat->din_area ?? '') }}">
				</div>{{-- form-group --}}
				<div class="form-group">
					<label for="living_area">Wohnfläche</label>
					<input
						type="text"
						class="form-control @error('living_area') is-invalid @enderror"
						id="living_area"
						placeholder="Wohnfläche"
						name="living_area"
						value="{{ old('living_area', $flat->living_area ?? '') }}">
				</div>{{-- form-group --}}
				<div class="form-group">
					<label for="heated_area">Heizfläche</label>
					<input
						type="text"
						class="form-control @error('heated_area') is-invalid @enderror"
						id="heated_area"
						placeholder="Heizfläche"
						name="heated_area"
						value="{{ old('heated_area', $flat->heated_area ?? '') }}">
				</div>{{-- form-group --}}
				<div class="form-group">
					<label for="useable_area">Nutzfläche</label>
					<input
						type="text"
						class="form-control @error('useable_area') is-invalid @enderror"
						id="useable_area"
						placeholder="Nutzfläche"
						name="useable_area"
						value="{{ old('useable_area', $flat->useable_area ?? '') }}">
				</div>{{-- form-group --}}
				<div class="form-group">
					<label for="balcony_area">Balkonfläche</label>
					<input
						type="text"
						class="form-control @error('balcony_area') is-invalid @enderror"
						id="balcony_area"
						placeholder="Balkonfläche"
						name="balcony_area"
						value="{{ old('balcony_area', $flat->balcony_area ?? '') }}">
				</div>{{-- form-group --}}
			</div><!-- /.card-body -->
		</div><!-- /.card -->
		<div class="card">
